...
<head>
    ...
    <title>Mã OTP đã gửi - BADMINTON PRO SHOP</title>
    <base href="{{ asset('/') }}">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-lg shadow-lg border border-gray-100 p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">Mã OTP đã được gửi!</h1>
                    <p class="text-gray-600 text-sm">Chúng tôi đã gửi mã OTP đặt lại mật khẩu đến email của bạn.</p>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                    ...
                    <ol class="list-decimal list-inside space-y-1 text-sm text-gray-600">
                        ...
                        <li>Ghi nhớ mã OTP gồm 6 chữ số</li>
