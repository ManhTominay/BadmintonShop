...
<body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            ...
            <form action="{{ url('/giay-cau-long') }}" method="GET" class="flex flex-wrap items-center gap-3">
                <div class="relative">
                    ...
                    @if(request('keyword'))
                        <a href="{{ url('/giay-cau-long') }}" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 text-xs"><i class="fa-solid fa-xmark"></i></a>
                    @endif
                </div>
