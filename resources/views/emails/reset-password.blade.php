                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; overflow:hidden; border:1px solid #e5e7eb;">
                    ...
                    <tr>
                        <td style="padding:30px;">
                            <h2 style="margin:0 0 16px; font-size:28px; color:#111827;">Mã OTP đặt lại mật khẩu</h2>
                            ...
                            <p style="margin:0 0 24px; text-align:center;">
                                <strong style="display:inline-block; color:#f97316; font-size:36px; letter-spacing:8px;">{{ $otp }}</strong>
                            </p>
